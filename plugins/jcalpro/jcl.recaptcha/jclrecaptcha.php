...
class Jclrecaptcha {
  ...
  <noscript>
    ...
    if ( $params->get( 'showAudioBtn', 1 ) == 0 ) {
      echo "<script type='text/javascript'> $('recaptcha_switch_audio').style.display='none';</script>\n";
    }

    if ( $params->get( 'showHelpBtn', 1 ) == 0 ) {
      echo "<script type='text/javascript'> $('recaptcha_whatsthis_btn').style.display='none';</script>\n";
    }

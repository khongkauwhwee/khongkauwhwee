...
var gallery = new Class({
	...
	showInfoSlideShow: function() {
		...
		zoneheight = element.getElement('h2').getStyle('height').toInt()+ 2 * (element.getElement('h2').getStyle('margin').toInt())
			+ element.getElement('p').getStyle('height').toInt()
			+ 2 * (element.getElement('p').getStyle('margin').toInt());
		this.slideInfoZone.custom({'opacity': [0, this.options.slideInfoZoneOpacity], 'height': [0, zoneheight]});
		if (this.options.showCarousel)

...
function editThemes( $option, $uid, $client ) {
  ...
  if ($uid) {
    ...
    // xml file for module
    $xmlfile = JPATH_ROOT . DS . 'plugins'. DS . 'editors'. DS . 'tinymce'. DS . 'jscripts'. DS . 'tiny_mce'. DS . 'themes'. DS .$row->theme . DS . $row->theme .'.xml';
    ...
    //$folders = mosReadDirectory( JPATH_ROOT .DS . 'plugins'. DS . 'editors'. DS . 'tinymce'. DS . 'jscripts'. DS . 'tiny_mce'. DS . 'themes' . DS );
    $folders = JFolder::folders(JPATH_ROOT .DS . 'plugins'. DS . 'editors'. DS . 'tinymce'. DS . 'jscripts'. DS . 'tiny_mce'. DS . 'themes');
    $folders2 = array();
    foreach ($folders as $folder) {
      if (is_dir( JPATH_ROOT . DS . 'plugins'. DS . 'editors'. DS . 'tinymce'. DS . 'jscripts'. DS . 'tiny_mce'. DS . 'themes'. DS . $folder ) && ( $folder <> 'CVS' ) ) {

 ...
 **********************************************
 ...
 $Id: events.html.php 634 2010-03-30 11:49:34Z shumisha $
...
<table class="adminheading">
	<tr>
		...
		<td>&nbsp;Range:&nbsp;</td>
		<td><?php echo $lists['date_range'];?></td>
		<td>&nbsp;Show:&nbsp;</td>
		<td><?php echo $lists['month_to_show'];?></td>
		<td><?php echo $lists['year_to_show'];?></td>
		<td>&nbsp;Recur. events:&nbsp;</td>
		<td><?php echo $lists['show_children'];?></td>
		<td>&nbsp;Filter:&nbsp;</td>

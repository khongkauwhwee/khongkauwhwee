...
switch ($task) {
  ...
  case 'newCalendar':
    TOOLBAR_extcalendarCalendars::_EDITCALENDAR();
    break;
  ...
  case 'saveCalendar':
    TOOLBAR_extcalendarCalendars::_DEFAULTCALENDARS();
    break;
  ...
  default:
    // show main panel toolbar only if another controller is not used
    // this ocntroller will have its own toolbar
    if (empty( $section)) {
      TOOLBAR_extcalendar::_JCAL_MAIN();
    }
    break;

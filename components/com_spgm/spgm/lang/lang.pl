...
$spgm_cfg['locale']['filterNew'] = 'nowe zdjêcia';

# filter value for 'all pictures'
$spgm_cfg['locale']['filterAll'] = 'wszystkie zdjêcia';

# filter value for 'slideshow'
$spgm_cfg['locale']['filterSlideshow'] = 'Slideshow';

# pictures navi bar
$spgm_cfg['locale']['pictureNaviBar'] = 'zdjêcie >CURRENT_PIC< z >NB_PICS<';

# picture label (as in '1 picture')
$spgm_cfg['locale']['picture'] = 'zdjêcie';

# pictures label (as in '2 pictures')
$spgm_cfg['locale']['pictures'] = 'zdjêcia';

# new picture label (as in '1 new picture')
$spgm_cfg['locale']['newPicture'] = 'nowe zdjêcie';

# new pictures label (as in '2 new pictures')
$spgm_cfg['locale']['newPictures'] = 'nowe zdjêcia';

# new gallery label
$spgm_cfg['locale']['newGallery'] = 'nowa galeria';

# main gallery label
$spgm_cfg['locale']['rootGallery'] = 'galeria g³ówna';

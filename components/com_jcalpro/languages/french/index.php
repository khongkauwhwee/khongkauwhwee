...
$lang_info = array (
	...
	,'expand' => 'Développer'
	,'collapse' => 'Réduire'
	,'any_calendar' => 'Tous les calendriers'
	,'noon' => 'midi'
  ,'midnight' => 'minuit'
  ,'am' => 'am'
  ,'pm' => 'pm'
  ...
  ,'show_required_privileges' => 'Votre niveau d\'accès est %s alors qu\'il devrait être au moin %s'  // JCal 2.1
  ,'template_block_not_found' => '<b>Erreur de gabarit<b><br />Bloc \'%s\' introuvable dans :<br /><pre>%s</pre>'
  ,'template_file_not_found' => '<b>Erreur critique</b>:<br />Impossible de charger le gabarit %s!</b>'
	);
...
EOT;
	...
	// new JCalpro 2
	,'repeat_event_detached' => 'Cet évènement fait partie d\'une répétition, mais a été modifié et séparé de cette dernière'
	,'repeat_event_detached_short' => 'Détaché de la répétition'
	,'repeat_event_not_detached' => 'Cet évènement fait partie d\'une répétition'
	,'repeat_edit_parent_event' => 'Modifier l\'évènement parent'
	,'deleted_child_events' => 'Effacé %d occurences précédentes'
	,'created_child_events' => 'Créé un total de %d occurences de l\'évènement %s. <a href="%s" >Cliquez ici.</a> pour le voir.'  // Jcal Pro 2.1.x
	...
	,'no_recur_end_date' => 'Un évènement répété doit avoir une date de fin ou un nombre maxi de répétitions'
	// new JCalpro 2
	,'failed_existing_event_update' => 'Erreur lors de la mise à jour de %s (%d)'
	,'failed_child_event_deletion' => 'Erreur lors de l\'effacement de %s (%d)'
	,'failed_child_event_creation' => 'Erreur lors de la création des répétitions de %s (%d)'
	,'no_calendar' => 'Vous devez choisir un calendrier dans la liste déroulante !'
	,'event_cal' => 'Calendrier'
	,'private_event' => 'Evènement privé'
	,'private_event_read_only' => 'Evènement privé, mais visible'
	,'public_event' => 'Evènement public'
	,'privacy' => 'Visibilité'
	...
	,'submit_event_approved' => 'Votre événement est automatiquement approuvé. <a href="%s" >Cliquez ici</a> pour voir cet évènement. Merci pour votre collaboration !'
	,'event_repeat_msg' => 'Cet événement est prévu pour être répété'
	,'event_no_repeat_msg' => 'Cet événement ne se répète pas'
  ,'recur_start_date_invalid' => 'La date de début n\'est pas valide. Un évènement répétitif doit démarrer sur la première occurence de la série (exemple: si "répéter chaque mardi" : la date de début doit être un mardi)'
  ...
  ,'rec_day_first' => 'premier'
  ,'rec_day_second' => 'second'
  ,'rec_day_third' => 'troisième'
  ,'rec_day_fourth' => 'quatrième'
  ,'rec_day_last' => 'denier'
  ,'rec_day_day' => 'jour'
  ,'rec_day_week_day' => 'jour de semaine'
  ,'rec_day_weekend_day' => 'jour de week-end'
  ,'rec_yearly_on_month_label' => 'en'
	);
...
EOT;
	...
	'cat_has_events' => 'La catégorie %d contient %d événement(s) et ne peut donc pas être détruite !<br>Détruisez les événements restants dans cette catégorie et recommencer à nouveau !'
	...
	,'timezone' => 'Utiliser ce fuseau horaire pour identifier heure d\'hiver/heure d\'été'
  ...
  'view_full_cal' => 'Voir calendrier'
  ,'add_new_event' => 'Ajouter évènement'
  ,'recent_events' => 'Evènements récents'
  ,'no_events_scheduled' => 'Aucun évènement pprévu pour le moment.'
  ,'more_days' => ' jours'
  ,'days_ago' => ' jours'
  );

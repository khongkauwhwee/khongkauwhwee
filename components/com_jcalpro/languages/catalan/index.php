...
EOT;
	...
	,'submit_event_approved' => 'El seu esdeveniment ha estat automàticament aprovat. View this event by <a href="%s" >clicking here</a>. Gracies per enviar-lo!'
...
EOT;
	...
	'no_cats' => 'No hi ha categories per mostrar!',
	'cat_has_events' => 'Categoria %d conté %d esdeveniment(s) i per aixó no es pot esborrar!<br>Si us plau, esborri els esdeveniments d\'aquesta categoria i provi de nou'
	...
	,'timezone' => 'Utilizar este zona horaria per estalvi de llum diürna (DST)'

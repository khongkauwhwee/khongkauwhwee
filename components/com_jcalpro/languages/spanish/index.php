 ...
 **********************************************
 *
 * Translation updated by Damià Verge
 * 
 */
...
$lang_info = array (
  ...
  ,'author' => 'Jorge Bernardo,Damià Verge'
  ,'author_email' => ''
  ,'author_url' => ''
  ,'transdate' => '03/16/2010'
  );
  ...
  ,'show_required_privileges' => 'Su nivel de usuario es %s, se necesita %s'  // JCal 2.1
...
EOT;
  ...
  // new JCalpro 2
  ,'repeat_event_detached' => 'Este evento pertenece a una repetición, pero ha sido modificado y separado de ella'
  ,'repeat_event_detached_short' => 'Separado de repetición'
  ,'repeat_event_not_detached' => 'Evento es parte de repetición'
  ,'repeat_edit_parent_event' => 'Modificar parento del evento'
  ,'deleted_child_events' => 'Bojado %d eventos fillos'
  ...
  ,'submit_event_approved' => 'Su evento ha sido automáticamente aprobado. View this event by <a href="%s" >clicking here</a>. Gracias por enviarlo!'
...
EOT;
  ...
  'no_cats' => 'No hay categorías para mostrar !',
  'cat_has_events' => 'Categoría contiene %d evento(s) y por esto no puede ser eliminada!<br>Por favor saque los eventos bajo esta categoría y pruebe de nuevo!'
  ...
  ,'timezone' => 'Zona horaria para ahorro de luz diurna'

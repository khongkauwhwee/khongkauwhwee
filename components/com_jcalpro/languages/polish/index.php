...
$lang_info = array (
  ...
  ,'expand' => 'Rozszerz'
  ,'collapse' => 'Zmniejsz'
  ,'any_calendar' => 'Pokaż wszytskie kalendarze'
  ,'noon' => 'noon'
  ,'midnight' => 'midnight'
  ,'am' => 'am'
  ,'pm' => 'pm'
  ...
  ,'full_date_time_24hour' => '%A,  %d %B %Y' // e.g. Wednesday, June 05, 2002 At 21:05
  ,'full_date_time_12hour' => '%A, %d %B %Y o %I:%M %p' // e.g. Wednesday, June 05, 2002 At 9:05 pm
...
EOT;
  ...
  'section_title' => 'Wydarzenia w miesiącu'
  ...
  ,'total_events' => 'Ilość wydarzeń'
  ,'upcoming_events' => 'Nadchodzące wydarzenia'
  ,'no_cats' => 'Nie ma jeszcze założonych kategorii.'
  ,'stats_string' => 'Dostępnych jest <strong>%d</strong> wydarzeń w <strong>%d</strong> kategoriach'
  );
...
EOT;
  ...
  'no_cats' => 'Nie ma jeszcze założonych kategorii!',
  'cat_has_events' => 'Kategoria %d zawiera %d wydarzeń i w związku z tym nie można jej usunąć <br>Usuń najpierw istniejące wydarzenia i spróbuj ponownie!'
  ...
  if (!defined('_EXTCAL_THEMES_INSTALL_HEADING'))
  {
    ...
    //Common
    DEFINE('_EXTCAL_VERSION', 'Wersja');
    DEFINE('_EXTCAL_DATE', 'Data');
    DEFINE('_EXTCAL_AUTHOR', 'Autor');
    DEFINE('_EXTCAL_AUTHOR_EMAIL', 'E-Mail autora');
    DEFINE('_EXTCAL_AUTHOR_URL', 'URL autora');
    DEFINE('_EXTCAL_PUBLISHED', 'Opublikowany');

    //Plugins
    DEFINE('_EXTCAL_THEME_PLUGIN', 'Szablon');
    DEFINE('_EXTCAL_THEME_PLUGCOM', 'Theme/Command');
    DEFINE('_EXTCAL_THEME_NAME', 'Nazwa');
    ...
    DEFINE('_EXTCAL_THEME_DEFAULT', 'Domyślny');
    DEFINE('_EXTCAL_THEME_ORDER', 'Zamów');
    ...
    DEFINE('_EXTCAL_THEME_DESC', 'Opis');
    DEFINE('_EXTCAL_THEME_EDIT', 'Edytuj');
    DEFINE('_EXTCAL_THEME_NEW', 'Nowy');
    DEFINE('_EXTCAL_THEME_DETAILS', 'Szczegółty dodatku');
    ...
    //Language Manager
    DEFINE('_EXTCAL_LANG_HEADING', 'EXTCAL Zarządzanie językami');
    DEFINE('_EXTCAL_LANG_LANG', 'Język');

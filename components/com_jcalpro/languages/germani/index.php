...
$lang_info = array (
	'name' => 'German'
	,'nativename' => 'Deutsch' // Sprache name in native language. E.g: 'Franï¿½ais' for 'French'
...
EOT;
	...
	,'submit_event_approved' => 'Deine Veranstaltung wurde automatisch freigeschaltet. View this event by <a href="%s" >clicking here</a>. Danke f&#252;r deinen Beitrag'
...
EOT;
	...
	'no_cats' => 'Es gibt keine Veranstaltungen !',
	'cat_has_events' => 'Rubrik %d enth&#228;lt %d Veranstaltungsdaten und kann nicht gel&#246;scht werden!<br>Bitte l&#246;sche die Veranstaltungen einzeln bevor du diese Rubrik l&#246;schst!'
  ...
  ,'days_ago' => ' Days Ago'
	...
	if (!defined('_EXTCAL_THEMES_INSTALL_HEADING'))
	{
	  ...
	  DEFINE('_EXTCAL_LANG_BACK', 'Zurï¿½ck zum Sprachen Manager');
	  //

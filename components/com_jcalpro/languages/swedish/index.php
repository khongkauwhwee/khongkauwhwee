...
EOT;
	...
	,'submit_event_approved' => 'Din händelse är automatiskt godkänd. View this event by <a href="%s" >clicking here</a>. Tack för ditt bidrag!'
...
EOT;
	...
	'no_cats' => 'Det finns inga kategorier att visa !',
	'cat_has_events' => 'Kategori %d innehåller %d händelse(er) och kan därför inte raderas!<br>Radera kvarvarande händelser i denna kategori och försök igen!'

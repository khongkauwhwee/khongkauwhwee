...
EOT;
	...
	,'submit_event_approved' => 'Seu evento está automaticamente aprovado. <a href="%s" >clicking here</a>. Obrigado pela sua participação !'
...
EOT;
	...
	'cat_has_events' => 'Categoria %d contém %d evento(s) e não pode ser deletada!<br>Por favor, delete os eventos que restam nessa categoria e tente novamente!'
	...
	,'timezone' => 'Utilizar este fuso Horário para buscar horário de verão (DST) '

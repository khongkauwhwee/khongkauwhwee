...
/**
 *
 * @version   $Id: shDecorator.php 599 2010-03-19 17:35:30Z shumisha $
...
class ShAbstractDecorator {
  ...
  public function __get( $property) {
    ...
    if (property_exists( $this->_decorated, $property) || $this->_decoratedIsDecorator) {
      ...
      throw new Exception ('Trying to get non-existent property for class ' . $this->_decoratedClass);
    }
  }

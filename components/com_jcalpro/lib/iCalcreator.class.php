 ...
 **********************************************
 ...
 $Id: feeds.inc.php 326 2010-06-09 21:59:13Z shumisha $
...
/*         A little setup                                                        */
/*********************************************************************************/
define( 'ICALCREATOR_VERSION', 'jCal Pro 2.2.10.545' );
/*********************************************************************************/
/*********************************************************************************/
/**
 * vcalendar class
  ...
  function setConfig( $config, $value ) {
    switch( strtoupper( $config )) {
      ...
      case 'FILENAME':
        ...
        // shumisha : removed creation of localfile
        // when setting the filename. In cases where
        // the ics file is downloaded by user,
        // we end up with an empty file left over
        // start code removed
  ...
  function parse( $filename=FALSE ) {
    ...
    if( is_array( $this->components ) && ( 0 < count( $this->components ))) {
      for( $six = 0; $six < count( $this->components ); $six++ )
        ...
        //shumisha : modified for jCal integration - bug reported
        return true;
    }
    else

 ...
 **********************************************
 *
 * $Id: minical.inc.php 597 2010-03-18 19:31:44Z shumisha $
 *
...
if (!function_exists( 'jclMinical')) {
  ...
  function jclMinical( $params, $moduleId, $profiledUserId = 0) {
    ...
    global $lang_general, $lang_date_format, $event_icons, $todayclr, $cat_id, $cal_id, $cat_list, $cal_list, $cats_limit, $extcal_code_insert, $Itemid, $private_events_mode;
...
EOT;
    ...
    for ($i=1;$i<=$nr;$i++)
    {
      ...
      $event_stack[$i]['num_events'] = count($events[$i]);

...
?>
  ...
  <body bgcolor="#D0D0D0" onBlur="setTimeout('window.close()',5000)"
        ...
        <tr bgcolor="#D8D8D8">
          <td colspan="18" height="23">
            <table border="0" cellpadding="0" cellspacing="2" width="100%">
              <tr>
                <td style="border: #000000 solid 1px" width="40" height="17"
                    bgcolor="#000000"><img name="sample" alt=""
                                       src="../images/spacer.gif" width="40" height="17" border="0"></td>
                <td width="100%" height="17" align="center"><input type="text"
                                                                     name="hextext" id="hextext" value="#000000" size="7"
                                                                   class="hextext" readonly="true"></td>
              </tr>
            </table>
          </td>
        </tr>
